...
For details, see the Help topics for the [New-CsClientVersionPolicy](https://technet.microsoft.com/en-us/library/gg398709\(v=ocs.15\)) cmdlet and the [Set-CsClientVersionPolicy](https://technet.microsoft.com/en-us/library/gg398876\(v=ocs.15\)) cmdlet.

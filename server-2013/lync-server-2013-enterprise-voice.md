...
> [!IMPORTANT]
> You may be looking for another similarly named feature, Lync calendar delegation. It doesn't require the Enterprise Voice feature and does allow users to schedule online Lync meetings from Outlook. If you've come here looking for that info, we recommend checking out <A href="https://technet.microsoft.com/en-us/library/gg398300(v=ocs.15)">Set-CsClientPolicy</A> for information on enabling Exchange delegate sync.

...
4.  Get the identity of the queue or question where the calls will be directed. At the command line, run:
    ...
    For details about creating the queue, see [New-CsRgsQueue](https://technet.microsoft.com/en-us/library/gg398989\(v=ocs.15\)).
...
7.  If you want to have prompts for calls that are received out of business hours or on holidays, use the **New-CsRgsPrompt** cmdlet to define the prompt, and use the **New-CsRgsCallAction** to define the action to be taken after the prompt. For details, see [New-CsRgsPrompt](https://technet.microsoft.com/en-us/library/gg398486\(v=ocs.15\)) and [New-CsRgsCallAction](https://technet.microsoft.com/en-us/library/gg398136\(v=ocs.15\)).
...
9.  Create or modify the workflow. To create a workflow, use **New-CsRgsWorkflow**. To modify a workflow, use **Set-CsRgsWorkflow**. At the command line, type:
    ...
    > [!NOTE]
    > For details about additional optional parameters, see <A href="https://technet.microsoft.com/en-us/library/gg398246(v=ocs.15)">New-CsRgsWorkflow</A> or <A href="https://technet.microsoft.com/en-us/library/gg425845(v=ocs.15)">Set-CsRgsWorkflow</A>

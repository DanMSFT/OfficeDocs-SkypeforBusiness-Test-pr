...
2.  Open the Lync Server 2013 Management Shell. The Lync Server 2013 Management Shell is automatically installed on each Front End Server or any computer where the Lync Server 2013 administrative tools have been installed. For details about the Lync Server 2013 Management Shell, see [Lync Server 2013 Management Shell](https://technet.microsoft.com/en-us/library/gg398474\(v=ocs.15\)) in the Operations documentation.

...
For details about the [Set-CsUser](https://technet.microsoft.com/en-us/library/gg398510\(v=ocs.15\)) cmdlet, see the Lync Server Management Shell documentation.

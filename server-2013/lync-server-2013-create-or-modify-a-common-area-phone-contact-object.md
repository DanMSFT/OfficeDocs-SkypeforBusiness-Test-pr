...
For details, see the Help topics for the [New-CsCommonAreaPhone](https://technet.microsoft.com/en-us/library/gg398430\(v=ocs.15\)) cmdlet and the [Set-CsCommonAreaPhone](https://technet.microsoft.com/en-us/library/gg398579\(v=ocs.15\)) cmdlet.

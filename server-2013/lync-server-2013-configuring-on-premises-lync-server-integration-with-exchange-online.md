...
For details about how to use the Lync Server Management Shell, see [Lync Server 2013 Management Shell](https://technet.microsoft.com/en-us/library/gg398474\(v=ocs.15\)).

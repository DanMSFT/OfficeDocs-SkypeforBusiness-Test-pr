...
For more information, see the help topic for the [Get-CsNetworkBandwidthPolicyProfile](https://technet.microsoft.com/en-us/library/gg425815\(v=ocs.15\)) cmdlet.
